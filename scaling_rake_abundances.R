...
#' what sclae they are using. We decided that we could reasonably infer the
#' scale used by revieing the max value recorded in a given year from each
...
king[!is.na(REL_ABUND) , .N , SURVEY_ID] # 1122 surveys
